...
import json
import requests
from aws_manager import AWSManager as am
import boto3
...
def uploadImg(inst, key, directory, photo1, photo2=None, isImgIdx = True, isMissingFace = False, noB64 = False):
    img_idx = '1'
    ...
    faceIDs = []
    while True:
        localPath = '.\\'+directory+'\\' + key + ('_' + img_idx if isImgIdx else '')+'.jpg'
...
def getPostImgAsB64(inst, key, isLong=False):
    ...
    post_path = '.\\posts\\' + key + '_' + post_pic_idx + '.jpg'
